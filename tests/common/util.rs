...
use rustgb::isa::{ArithmeticInstruction, BitInstruction, Condition, Instruction, JumpInstruction, LoadInstruction, MiscInstruction, StackInstruction};
...
pub fn disassemble_byte(byte: u8) -> Instruction {
    match Disassembler::bits_tup(byte) {
        ...
        (0, 0, a, b, 0, 0, 0, 1) => Instruction::Load(LoadInstruction::LdR16N16(RegisterPair::from_bits(a,b), 0)),
        ...
        (0, 0, a, b, c, 1, 1, 0) => Instruction::Load(LoadInstruction::LdR8N8(Register::from_bits(a,b,c), 0)),
        ...
        (0, 0, 1, a, b, 0, 0, 0) => Instruction::Jump(JumpInstruction::JrCCN8(Condition::from_bits(a,b), 0 as i8)),
        ...
        (1, 1, 0, a, b, 0, 1, 0) => Instruction::Jump(JumpInstruction::JpCCN16(Condition::from_bits(a,b), 0)),
        (1, 1, 0, 0, 0, 0, 1, 1) => Instruction::Jump(JumpInstruction::JpN16(0)),
        (1, 1, 1, 0, 1, 0, 0, 1) => Instruction::Jump(JumpInstruction::JpHL),
        (1, 1, 0, a, b, 1, 0, 0) => Instruction::Jump(JumpInstruction::CallCCN16(Condition::from_bits(a,b), 0)),
        (1, 1, 0, 0, 1, 1, 0, 1) => Instruction::Jump(JumpInstruction::CallN16(0)),
        (1, 1, a, b, c, 1, 1, 1) => Instruction::Jump(JumpInstruction::Rst((c << 2 | b << 1 | a) as u16 * 8)),
